...
指示功能： 关系子句具有指出「哪一个」的功能。具有指示功能的关系子句的who或which才能改成指示代名词that。

I met a friend who(that) went to the same high school with me. 先行词 关系子句 （我碰到一个从前的高中同学。）具有指示功能
I met Jack Wang, who went to the same high school with me. 先行词 关系子句 （我碰到 Jack 王，他是我从前的高中同学。）Jack Wang 独一无二的专有名字，不具有指示功能
I met a friend, quite by chance, who(that) went to the same high school with me. （非常巧，我碰到一个从前高中的老同学。）具有指示功能
...
关系代名词是受词可以选择省略，但是用逗号隔开作补充说明，不具有指示性，不能省略，主句和子句必须自给自足。
...
最常见的位置是在先行词后面, 修饰语和被修饰的对象尽量接近。放在什么位置最清楚，就应该放在什么位置。

I can’t leave a man [who has done so much for my family] behind. 不清楚，behind 会被误以为子句的一部分。
I can’t leave a man behind, [who has done so much for my family]. S V O C 关系子句

I found a book [which focuses on social relations] in the library. 不清楚，in the library 会被误以为子句的一部分, 修饰 social relations
...
You mustn’t let [what he said] bother you. S V O 关系子句 C 升格为名词子句

### whatever

Anything [that you say now] may be used against you in court. S 关系子句 V C
[Whatever you say now] may be used against you in court. S 关系子句 V C 升格为名词子句
